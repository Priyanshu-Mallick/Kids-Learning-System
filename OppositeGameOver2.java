 ...
 * @author hp
 */
public class OppositeGameOver2 extends javax.swing.JFrame {

    /**
     * Creates new form GameOver
     */
    public OppositeGameOver2() {
        initComponents();
       ...
       int ab;
   ab=Integer.parseInt(Level2_Opposite.jLabel6.getText());
...
MP3Player mp3player=new MP3Player(new File(SONG));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 500, 60, 60));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 500, 60, 60));
